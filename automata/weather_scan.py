...
Extracted from ``automata/weather_bot.run()`` so non-weather bots
...
def _city_from_slug(slug: str) -> str | None:
    from experiment.view import _city_date_from_slug
    city, _dt, _ = _city_date_from_slug(slug or "")
    return city


def _resolution_dt_for_event(event: dict[str, Any], slug: str) -> datetime | None:
    from experiment.view import _city_date_from_slug, _resolution_dt
...
def scan_and_record_events(
    ...
    *,
    ...
    from experiment.view import _parse_json_list
