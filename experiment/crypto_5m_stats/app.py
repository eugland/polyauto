...
def create_app(crypto_db_path: str, bets_db_path: str, eth_log_path: str, bs_log_path: str, eth5min_db_path: str = "", eth5min_log_path: str = "", temp_market_db_path: str = "") -> Flask:
    ...
    def api_eth5min():
        return jsonify(query_eth5min_stats(app.config["ETH5MIN_DB_PATH"]))

    @app.route("/api/eth5min-log")
    def api_eth5min_log():
        return jsonify({"lines": read_eth5min_log_tail(app.config["ETH5MIN_LOG_PATH"])})
