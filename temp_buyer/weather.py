...
def find_markets_for_city(city: str) -> list[dict]:
    ...
    from temp_buyer.polymarket import fetch_temperature_markets_payload
...
def _derive_clob_credentials() -> None:
    ...
    from temp_buyer import config as _config
    ...
    from temp_buyer.client import derive_api_credentials
...
def run_weather_daemon(
    ...
    log = logging.getLogger("temp_buyer.weather")

    from temp_buyer.db import init_db
    from temp_buyer import weather_model
    from temp_buyer.weather_bot import _scan_positions, run
    ...
    while True:
        ...
        if bet:
            ...
            try:
                from temp_buyer.client import build_client, get_usdc_balance
