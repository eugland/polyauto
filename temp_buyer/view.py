...
Usage:
  python -m temp_buyer.view highest-temperature-in-london-on-april-27-2026
  python -m temp_buyer.view https://polymarket.com/event/highest-temperature-in-london-on-april-27-2026
  python -m temp_buyer.view                       # all temp events resolving within 24h
  python -m temp_buyer.view <slug> --watch 5      # refresh every 5 seconds
"""
